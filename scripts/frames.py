...
sample_and_concatenate_gif("../assets/gifs/push_t_succ_0.gif", "../assets/images/push_t_succ_0.png")
sample_and_concatenate_gif("../assets/gifs/push_t_succ_1.gif", "../assets/images/push_t_succ_1.png")
sample_and_concatenate_gif("../assets/gifs/push_t_fail_0.gif", "../assets/images/push_t_fail_0.png")
sample_and_concatenate_gif("../assets/gifs/push_t_fail_1.gif", "../assets/images/push_t_fail_1.png")
...
plot_correlation_graph(x, y, xlabel="Actual Success Rate", ylabel="Predicted Success Rate", title="Push-T", output_path="../assets/images/correlation_graph.png")
